;(function ($) {
    ...
    var Foodymat = {
        ...
        _init: function () {
            ...
            var offCanvas = {
                ...
                drawer: $('.foodymat-offcanvas-drawer'),
                drawerClass: '.foodymat-offcanvas-drawer',
                menuDropdown: $('.dropdown-menu.depth_0'),
            };

            Foodymat.menuDrawerOpen(offCanvas);
            Foodymat.offcanvasMenuToggle(offCanvas);
            Foodymat.headerSearchOpen();
            Foodymat.backToTop();
            Foodymat.counterUp();
            Foodymat.pricingTab();
            Foodymat.preLoader();
            ...
            Foodymat.headRoom();
            Foodymat.wow();
            Foodymat.rtElementorParallax();
            Foodymat.rtAnimatedHeadline();
            Foodymat.magnificPopup();
            Foodymat.imageFunction();
            Foodymat.hasAnimation();
            Foodymat.rtMasonary();
            Foodymat.rtIsotope();
            Foodymat.swiperSlider($);
            Foodymat.horizontalSwiperSlider();
            Foodymat.heroSlider();
    ...
    $(window).on('scroll', (event) => {
        Foodymat.backTopTopScroll(event);
    });
