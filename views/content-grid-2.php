...
if ( foodymat_option( 'rt_blog_above_meta_visibility' ) && !empty( has_post_thumbnail() ) && !empty( $rt_post_gallerys_raw ) ) {
		...
		<div class="post-thumbnail-wrap">
					...
					<div class="swiper-wrapper">
						<?php foreach( $rt_post_gallerys as $rt_posts_gallery ) { ?>
							<div class="swiper-slide">
								<?php echo wp_get_attachment_image( $rt_posts_gallery, 'foodymat-size3', "", array( "class" => "img-responsive" ) );
								?>
							</div>
						<?php } ?>
					</div>
			...
			<?php } else { ?>
				<figure class="post-thumbnail">
					<a class="post-thumb-link alignwide" href="<?php the_permalink(); ?>" aria-hidden="true" tabindex="-1"><?php the_post_thumbnail( 'foodymat-size3' ); ?></a>
				</figure><!-- .post-thumbnail -->
<!--				--><?php //if ( foodymat_option( 'rt_blog_above_meta_visibility' ) && !empty( has_post_thumbnail() )) { ?>
<!--					<div class="posted-on">-->
...
<!--				--><?php //} ?>
		...
		<div class="entry-wrapper">
			<header class="entry-header">
				<?php if ( ! empty( $meta_list ) && foodymat_option( 'rt_meta_visibility' ) ) {
